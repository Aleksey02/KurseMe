	...
	return <div className={classes.courseAdvertising}>
		<div className={classes.courseAdvertising__box}>
			<div className={classes.courseAdvertising__info}>
				<p className={classes.courseAdvertising__label}>egeball20_bot</p>
				...
				<a href='https://t.me/egeball20_bot' target='_blank' className={classes.courseAdvertising__btn}>Купить Курсы</a>
			</div>
