    ...
    return (
        <div className={classes.item}>
            <div className={classes.item__up + ' ' + (isAnswerOpen?classes.active: '')}  onClick={()=>setIsAnswerOpen(prev=>!prev)}>
                ...
                {isAnswerOpen && <svg width="20px" height="20px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">
