...
function HowToLook() {
	const data = [
		{ src: '/video/HowToLook/video1.mp4', title: 'Как выглядит слив курса ФЛЕШ👆🏻', join: 'Вступить в курс:', joinStatus: '⚡️'},
		{ src: '/video/HowToLook/video2.mp4', title: 'Как выглядит слив курса КОРРИДА👆🏻', join: 'Вступить в курс:', joinStatus: '⚡️'},
		{ src: '/video/HowToLook/video3.mp4', title: 'Как выглядят каналы с курса «Предбанник» от Умскул👆', join: 'Вступить в курсы:'},
		{ src: '/video/HowToLook/video4.mp4', title: 'Как выглядят каналы с курса «Мясорубка» от 100балльного👆', join: 'Вступить в курсы:'},
	];
