...
function Reviews() {
	return <div className={classes.reviews} data-aos="zoom-in-up">
		...
		<div className={classes.reviews__box}>
			<img className={classes.reviews__img} src={review1} />
			<img className={classes.reviews__img} src={review2} />
			<img className={classes.reviews__img} src={review3} />
			<img className={classes.reviews__img} src={review4} />
			<img className={classes.reviews__img} src={review5} />
			<img className={classes.reviews__img} src={review6} />
		</div>
